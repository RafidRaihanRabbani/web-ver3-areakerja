...
<div id="id28" class="modal">
  ...
  <form class="modal-content animate" action="/action_page.php" method="get">
    ...
    <div class="container">
      ...
      <div class="container" style="background-color:#f1f1f1">
        <button type="button" onclick="document.getElementById('id28').style.display='none'" class="cancelbtn">Batal</button>
        <button onclick="document.getElementById('id28').style.display='block'" style="width:auto;">Tutup</button>
      </div>
  ...
  <form class="modal-content animate" action="/action_page.php" method="post">
    ...
    <div class="container">
      ...
      <div class="header" style="margin-bottom: 76px">
        ...
        <h1 style= "margin-left: 350px; font-size: 30px">CV Anda berhasil diunduh.</h1>
      </div>
