    ...
    <div class="limiter">
        <div class="container-peng100">
            ...
            <div class="wrap-peng101">
                <form class="peng100-form validate-form" method="POST" action="{{ route('login') }}">
                    {{ csrf_field() }}
                    ...
                    <div id="myDIV">
                        <form class="peng100-form validate-form" method="POST" action="{{ route('login') }}" style= "padding-top: 10px">
                            {{ csrf_field() }} 
                            <div class="wrap-input101 validate-input" data-validate="Masukan Password baru">
                                <label> Kata Sandi Lama</label>
                                <input id="password" class="input101 @error('password') is-invalid @enderror" required autocomplete="new-password" type="password" name="password" placeholder="Kata Sandi Lama" style= "margin-left: 450px">
                    ...
                    <div id="myDIV2">
                        <form class="peng100-form validate-form" method="POST" action="{{ route('login') }}" style= "padding-top: 10px">
                            ...
                            <div class="wrap-input101 validate-input" data-validate="Masukan kata sandi">
                                <input id="password" class="input101 @error('password') is-invalid @enderror" required autocomplete="new-password" type="password" name="password" placeholder="Masukan kata sandi" style= "margin-left: 450px">
