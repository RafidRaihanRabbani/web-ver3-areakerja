        ...
        <div class="container-login100" style= "background:#000000">
            ...
            <div class="col-lg-4" style= "background:#ffffff; padding: 50px; padding-above: 80px; padding-bottom: 78px;">
                <form class="register100-form validate-form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Valid Email is required">
                        <input id="email" class="input100 @error('email') is-invalid @enderror" required autocomplete="email" value="{{ old('email') }}" type="email" name="email" placeholder="No.Telepon Perusahaan">
