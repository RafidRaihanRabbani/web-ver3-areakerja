                    ...
                    <form>
                      ...
                      <div class="form-group">
                        <select id='Badan-usaha'>
                            <option label="Status Perkerjaan">Status Perkerjaan*</option>
                            <option label="Part Time">Part Time</option>
                            <option label="Full Time">Full Time</option>
                            <option label="Free Lance">Free Lance</option>
                          </select>
                     </div>
