    ...
    <div class="limiter">    
        ...
        <div class="image">
            <div class="female" style= "margin-top: -455px">
              ...
              <img src="{{ asset('img/female.png') }}" alt="IMG" style= "width: 20%; margin-left: -530px; margin-bottom: -30px">
            </div>
            <div class="male" style= "margin-left: 850px; margin-right: -50px; margin-top: -250px">
              <img src="{{ asset('img/Ellipse371.png') }}" alt="IMG" style= "width:120%; margin-top: -50px; margin-left: -100px" >
              <img src="{{ asset('img/male.png') }}" alt="IMG" style= "width:50%; margin-top: -320px; margin-left: 130px">
            </div>
        </div> 
    </div>    
