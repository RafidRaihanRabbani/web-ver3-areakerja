    ...
    <section class="relative">
        ...
        <div class= "text-center">
            ...
            <div class= "beranda100-pic">
                <img src="{{ asset('img/Blog.png') }}" alt="IMG">
            </div>
        </div>


        <div class= "row">
            <div class="col s1"><img src="{{ asset('img/Illustration.png') }}" ></div>
            <div class="col s1">
            ...
            <div class="col s1"><img src="{{ asset('img/018.png') }}" ></div>
            <div class="col s1">
        ...
        <div class="row">
            <div class="col">
                <div class="group">
                    <img src="{{ asset('img/Base.png') }}" alt="IMG" style= "width: 50%; margin-bottom: -430px">
                    <img src="{{ asset('img/Group.png') }}" alt="IMG" style= "width: 55%; margin-left: 50px; margin-top: -50px">
                </div>
            </div>
            <div class="col">
                <div class="aboutus100-pic">
                    <img src="{{ asset('img/Step.png') }}" alt="IMG" width= "80%" style= "margin-bottom: 200px">
                </div>
            </div>
        </div>
