...
@section('aboutus')
    <section class="relative">
        ...
        <div class="row">
            <div class="col">
                <div class="aboutus100-pic">
                    <img src="{{ asset('img/image.png') }}" alt="IMG" height="596px" width="544px">
                </div>
            </div>
            <div class="col">
        ...
        <div class="text-center">
            ...
            <div class= "row">
                <div class="col s4"><img src="{{ asset('img/Illustration.png') }}" >
                ...
                <div class="col s4"><img src="{{ asset('img/018.png') }}" >
