        ...
        <div class="row">
            ...
            <div class="col-lg-12" style= "padding-left: 350px">
                <div class="container footer-nav">
                    <a href="{{ route('home') }}"><img src="{{ asset('img/AREAKERJA.png') }}" style="width:300px; margin-left:25px;" alt="" title=""></a>
                ...
                <div class="footer-social" style= "padding-left: 80px; padding-up: 90px; padding-bottom: 50px;">
                    <ul class="col row">
                        <li>
                            <a href="{{ route('home') }}"><i class="fa fa-facebook-square" style="font-size:30px"></i></a>
                        </li>
                        <li>
                            <a href="{{ route('home') }}"><i class="fa fa-youtube-play" style="font-size:30px"></i></a>
                        </li>
                        <li>
                            <a href="https://www.instagram.com/areakerjacom/"><i class="fa fa-instagram" style="font-size:30px"></i></a>
                        </li>
                        <li>
                            <a href="{{ route('home') }}"><i class="fa fa-linkedin-square" style="font-size:30px"></i></a>
                        </li>
                    </ul>
                </div>
...
<footer class="page-footer special-color-dark  d-md-none d-lg-none d-xl-none">
    ...
    <ul class="col row " style="width: max-content;margin-left: auto;margin-right: auto">
        ...
        <li>
            <a href="{{ route('home') }}"><i class="fa fa-telegram" style="font-size:36px; color:#000000"></i></a>
        </li>
    </ul>
    <!-- Social buttons -->
