...
<?php $__env->startSection('aboutus'); ?>
    <section class="relative">
                ...
                <div class="text-left">
                    <div class="mt-5 ml-auto mr-5">
                        ...
                        <p class="col-sm-6 md-4 mb-5 ml-auto mr-auto"
                            style="font-size: 23pt; font-style: bold; margin: auto 20px; text-align: left; color:black;">
                ...
                <div class="col">
                    <div class="text-right">
                        <div class="beranda100-pic">
                            <img src="<?php echo e(asset('img/beranda1.png')); ?>" alt="IMG" height="400px" width="400px">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="beranda100-pic">
            <img src="<?php echo e(asset('img/Desktop.png')); ?>" alt="IMG" height="450" width="1150" style="padding-left=0">
        </div>
        

        <div class= "beranda100-pic">
            <div class= "text-right">
                <img src="<?php echo e(asset('img/18.png')); ?>" alt="IMG">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col">
                <div class="aboutus100-pic">
                    <img src="<?php echo e(asset('img/19.png')); ?>" alt="IMG" height="250px" width="348px">
                </div>
            </div>
            <div class="col">
        ...
        <div class="row">
            <div class="col">
                <div class="aboutus100-pic">
                    <img src="<?php echo e(asset('img/Group.png')); ?>" alt="IMG" height="400px" width="400px">
                </div>
            </div>
            <div class="col">
                <div class="aboutus100-pic">
                    <img src="<?php echo e(asset('img/Step.png')); ?>" alt="IMG" height="400px" width="400px">
                </div>
            </div>
        </div>
...
<?php echo $__env->make('user.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\web-ver2 areakerja\resources\views/beranda/berandape.blade.php ENDPATH**/ ?>