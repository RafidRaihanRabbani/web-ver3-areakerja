<nav class="navbar navbar-expand-lg navbar-light" id="header" id="home" style="background:transparent">
    <div class="container">
        <div id="logo2" class="navbar-brand animate__animated animate__flipInX">
            <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('img/AREAKERJA (2) 1.png')); ?>" style="width:180px;" alt="" title="" /></a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item mb-2 mb-md-0 mr-2">
                    <a role="button" class="nav-link form-pasang5" href="<?php echo e(route('hunter')); ?>"
                ...
                <li class="nav-item mb-2 mb-md-0 mr-3">
                    <a role="button" class="nav-link form-pasang px-2 " href="<?php echo e(route('AK')); ?>"
                        style="color: #000000; background-color: #fe7c5400; width:max-content; font-weight:600">
                        Kandidat <img src="<?php echo e(asset('img/img-01(2).png')); ?>" style="width:20px;" alt="" title="" />
                    </a>
                </li>

                <li class="nav-item mb-2 mb-md-0 mr-2">
                    <a role="button" class="nav-link form-pasang5" href="<?php echo e(route('pelamar')); ?>"
                ...
                <li class="nav-item mb-2 mb-md-0 mr-2">
                    <a role="button" class="nav-link form-pasang5" href="<?php echo e(route('pilihpaket')); ?>"
                        style="color: #000000; font-size: 14px;  font-weight:600">
                        Pasang Lowongan
                    </a>
                </li>
...
<?php /**PATH D:\XAMPP\htdocs\web-ver3 areakerja\resources\views/partials/header2.blade.php ENDPATH**/ ?>