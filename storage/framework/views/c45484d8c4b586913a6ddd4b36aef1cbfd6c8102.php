<nav class="navbar navbar-expand-lg navbar-light" id="header" id="home" style="background:transparent">
    <div class="container">
        <div id="logo2" class="navbar-brand animate__animated animate__flipInX">
            <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('img/img-01(2).png')); ?>" style="width:80px;" alt="" title="" /></a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item mb-2 mb-md-0 mr-3">
                    <a role="button" class="nav-link form-pasang px-2 " href="<?php echo e(route('daftarkandidat')); ?>"
...
<?php /**PATH D:\XAMPP\htdocs\web-ver2 areakerja\resources\views/partials/header2.blade.php ENDPATH**/ ?>