...
<meta property="og:image" content="<?php echo e(asset('img/AREAKERJA (2) 1.png')); ?>">
...
<section class="relative" id="home">
    <div class="banner">
        <div class= "hunter">
            <img src="<?php echo e(asset('img/hunter3.png')); ?>" alt="" class="img-fluid" style= "width: 90%; margin-left: 75px">
        </div>
        <div class="row align-items-center" style="margin-right: 15px; margin-left: -570px; margin-top: -50px">
            <div class="banner-content col-lg-12">
                ...
                <a href="<?php echo e(route('berandape')); ?>">
        ...
        <div class="container" style= "padding-top: 230px">
            ...
            <div class="row">
                <div class="col-md-6" style="overflow:hidden">
                    <img src="<?php echo e(asset('img/hunter2.png')); ?>" alt="" class="img-fluid" style="margin-top:-0px; width: 100%; margin-left: 50px;">
                </div>
                <div class="col-md-6">
...
<?php echo $__env->make('user.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\web-ver3 areakerja\resources\views/talent/talent.blade.php ENDPATH**/ ?>