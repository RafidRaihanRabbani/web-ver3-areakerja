...
<head>
    <meta charset="UTF-8">
    <link rel="shortcut icon" href="<?php echo e(asset('img/img-01(2).png')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.cs')); ?>s">
    <!-- iCheck -->
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show">
    <?php if (\Illuminate\Support\Facades\Blade::check('admin')): ?>
        <header class="app-header navbar" style="background: linear-gradient(135deg, #FEC163 0%, #DE4313 100%)">
            <button class="navbar-toggler sidebar-toggler d-lg-none mr-auto" type="button" data-toggle="sidebar-show">
                <span class="navbar-toggler-icon"></span>
            </button>
            <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('img/AREAKERJA.png')); ?>" alt="" title="" style="margin-top: -10px;; width: 190px" />
            </a>
                    ...
                    <li class="nav-item dropdown d-md-down-none">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <?php $__currentLoopData = config('panel.available_languages'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $langLocale => $langName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a class="dropdown-item" href="<?php echo e(url()->current()); ?>?change_language=<?php echo e($langLocale); ?>"><?php echo e(strtoupper($langLocale)); ?>
    ...
    <script src="<?php echo e(asset('js/app2admin.js')); ?>"></script>
    <script>
...
<?php /**PATH D:\XAMPP\htdocs\web-ver3 areakerja\resources\views/layouts/admin.blade.php ENDPATH**/ ?>