                ...
                <div class="banner-content col-lg-12">
                    <div class="overlay overlay-bg container">
                        <h5 class="mt-3 text-right" style="color: #00000062; ">
                            Areakerja.com >
                            <a style="color: #00000062; " href="<?php echo e(route('artikel')); ?>">Pasang Lowongan</a>
                        </h5>
                    ...
                    <div class="row align-items-center ">
                        ...
                        <div class="col-8 col-sm-9 no-padding my-3 pr-1">
                            ...
                            <h5 class="paket2" style="line-height: 1.6!important;font-weight: normal;">Ribuan
                                pencari kerja
                                mengunjungi
                                <a href="<?php echo e(route('home')); ?>">website</a>
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-4 px-4 ">
                    <a href="" data-bs-toggle="modal" data-bs-target="#pop<?php echo e($pak->id); ?>">
                        <div class="card mb-4 form-wrap-main2"
                            style="border-radius: 25px; border:5px solid <?php echo e($pak->warna); ?> ">
                            <div class="card-header pt-3 pb-4"
                                style="border-radius:  25px 25px 200px 200px/25px 25px 45px 45px; height: auto;background-color: <?php echo e($pak->warna); ?>">
...
<?php $__env->stopSection(); ?>
<?php $__env->startSection('awanatas'); ?>
    <div class="awan">
...
<?php $__env->stopSection(); ?>
<?php $__env->startSection('awanbawah'); ?>
    <div class="awan2">
...
<?php echo $__env->make('layouts.pasang', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\web-areakerja-2\resources\views/pasang/paket.blade.php ENDPATH**/ ?>