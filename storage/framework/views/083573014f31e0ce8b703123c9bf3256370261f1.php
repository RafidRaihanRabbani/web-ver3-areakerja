                    ...
                    <div class= "tambah" style= "padding-bottom: 10px; margin-left: -580px">
                        <div class= "container" style= "background-color: #FFF0E2; height: 250px; width: 200px; padding-top: 10px; padding-bottom: 10px; border-radius: 25px">
                            <div class= "container" style= "background-color: #FF9837; height: 150px; margin-top: 40px; border-radius: 25px">
                                <a class="txt2" href="<?php echo e(route('adminlupa')); ?>" style="color: #ffffff; font-size: 50px; margin-right: -50px;">
...
<?php echo $__env->make('user.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\web-ver3 areakerja\resources\views/pengaturan/profile.blade.php ENDPATH**/ ?>