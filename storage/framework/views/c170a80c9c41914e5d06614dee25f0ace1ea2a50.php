            ...
            <div class="wrap-login100">
                ...
                <div class="login100-pic js-tilt" data-tilt>
                    <a href="<?php echo e(route('home')); ?>">
                        <img src="<?php echo e(asset('img/signPela.png')); ?>" alt="IMG"> </a>
                </div>
                ...
                <form class="login100-form validate-form" method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="text-right p-t-12">
                        ...
                        <a class="txt2" style= "color: orange" href="<?php echo e(route('register')); ?>">
                            Ayo daftar
                        </a>
                    </div>
                    ...
                    <div class="container-home100-form-btn">
                        <button class="home100-form-btn" type="submit" href="<?php echo e(route ('home')); ?>">
                            Home
                        </button>
                    </div>
...
<?php /**PATH D:\XAMPP\htdocs\web-ver2 areakerja\resources\views/auth/login.blade.php ENDPATH**/ ?>