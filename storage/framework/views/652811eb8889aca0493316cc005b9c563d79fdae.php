...
<button onclick="document.getElementById('id08').style.display='block'" style="width:auto;">Alamat</button>
<button onclick="document.getElementById('id11').style.display='block'" style="width:auto;">Tutup Lowongan</button>
<button onclick="document.getElementById('id12').style.display='block'" style="width:auto;">Lowongan berhasil di tutup</button>
...
<?php /**PATH D:\XAMPP\htdocs\web-ver3 areakerja\resources\views/auth/draft.blade.php ENDPATH**/ ?>