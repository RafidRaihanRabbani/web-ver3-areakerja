...
<body>
    ...
    <div class="d-flex flex-column">
        <nav>
            <img  style="position: absolute" src="<?php echo e(asset('img/kandidat/Vector 1.svg')); ?>" alt="" class="d-none d-lg-block">
        ...
        <main class="flex-fill">
            ...
            <?php echo $__env->yieldContent('awanatas'); ?>
            <div  style="background-color: #ffffff">
                <?php echo $__env->yieldContent('slick'); ?>
            </div>
            <?php echo $__env->yieldContent('awanbawah'); ?>

            <?php echo $__env->yieldContent('slick2'); ?>
                    ...
                    <div class="modal-body" >
                        <div class="login-sec-bg">
                            ...
                            <form id="example-advanced-form" enctype="multipart/form-data"
                                action="<?php echo e(url('formkandidat')); ?>" method="POST" style="display: none;">
                                <?php echo csrf_field(); ?>
                                <h3 >Account</h3>
                                <fieldset class="form-input"  style="overflow-y: scroll; box-sizing: border-box;width: 100%;">
                                    ...
                                    <select name="skillutama" id="skillutama" class="form-control2">
                                        <?php $__currentLoopData = $mainSkill1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($skill->nama); ?>" class="nama"><?php echo e($skill->nama); ?></option>
                    ...
                    <div class="modal-body" >
                        <div class="login-sec-bg">
                            ...
                            <form id="example-advanced-form1" enctype="multipart/form-data"
                                action="<?php echo e(url('formmitra')); ?>" method="POST" style="display: none;">
                                <?php echo csrf_field(); ?>
                                <h3 >Account</h3>
                                <fieldset class="form-input"  style="overflow-y: scroll; box-sizing: border-box;width: 100%;">
                                    <h4>Account Information</h4>
    ...
    <script src="<?php echo e(asset('js/app2pasang.js')); ?>"></script>
        ...
        $(document).ready(function() {
            ...
            $('#add2').click(function() {
                ...
                $('#dynamic_field2').append('<tr id="row' + i2 +
                    ...
                    i2 +
                    '" class="btn btn-area btn_remove">X</button></td></tr><script src="<?php echo e(asset('js/slider.js')); ?>" />'
                );
            });
...
<?php /**PATH D:\XAMPP\htdocs\web-ver2 areakerja\resources\views/layouts/pasang3.blade.php ENDPATH**/ ?>