...
<section class="relative" id="home">
    <div class="banner">
        <div class= "ak">
            <img src="<?php echo e(asset('img/ak.png')); ?>" alt="" class="img-fluid" style= "width: 90%; margin-left: 75px">
        </div>
...
<?php echo $__env->make('user.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\web-ver3 areakerja\resources\views/kandidat/AK.blade.php ENDPATH**/ ?>