...
<?php $__env->startSection('aboutus'); ?>
    <section class="relative" id="home">
        <div class="container" style= "margin: 200px; margin-right: 180px; margin-left: -10px; padding: 100px; padding-right: 300px; background:#ffffff">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form class="konfirmasi" method="POST" action="<?php echo e(route('login')); ?>" >
                        ...
                        <div class="text-right p-t-12" style= "margin-right: 15px; padding-bottom: 30px;">
                            <a class="txt2" href="<?php echo e(route('Keterima')); ?>" style= "color: #FF9837">
...
<?php echo $__env->make('user.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\web-ver3 areakerja\resources\views/pelamar/Konfirmasi.blade.php ENDPATH**/ ?>