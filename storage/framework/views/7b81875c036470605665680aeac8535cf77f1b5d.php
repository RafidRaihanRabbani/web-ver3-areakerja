        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="container footer-nav">
                    <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('img/AREAKERJA.png')); ?>" style="width:350px; padding-up: 10pt; padding-bottom: 10pt; padding-right: 50pt" alt="" title="" /></a>
            ...
            <div class="col-lg-6">
                <div class="container footer-nav">
                    <ul class="bottom" style="padding-left: 300.5px; padding-up: 30px;">
                        ...
                        <li>
                            <a href="<?php echo e(route('aboutus')); ?>" style="color: #ffffff; font-size: 9pt; padding-left: 70px">Tentang Kami</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('kontak')); ?> " style="color: #ffffff; font-size: 9pt; padding-left: 75px">Kontak Kami</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('FAQ')); ?>" style="color: #ffffff; font-size: 9pt; padding-left: 120px">FAQ</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="footer-social">
                <ul class="row center" style="margin-left:450px;">
                    ...
                    <li>
                        <a href="<?php echo e(route('home')); ?>"><i class="fa fa-facebook-square"
                                style="font-size:24px; color: #ffffff"></i></a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('home')); ?>"><i class="fa fa-twitter-square"
                                style="font-size:24px; color: #ffffff"></i></a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('home')); ?>"><i class="fa fa-linkedin-square"
                                style="font-size:24px; color: #ffffff"></i></a>
                    </li>
                </ul>
            </div>
...
<?php /**PATH D:\XAMPP\htdocs\web-ver3 areakerja\resources\views/user/footer.blade.php ENDPATH**/ ?>