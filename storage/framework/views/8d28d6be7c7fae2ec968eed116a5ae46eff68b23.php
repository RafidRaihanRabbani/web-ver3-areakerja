                ...
                <form class="login100-form validate-form" method="POST" action="<?php echo e(route('login')); ?>">
                  ...
                  <hr class= "hrareakerja2">
                    ...
                    <div class="text-right p-t-12">
                        <a class="txt2" href="<?php echo e(route('superlupa')); ?>" style="color: #F21919">
                            Forgot Password?
                        </a>
                    </div>
...
<?php /**PATH D:\XAMPP\htdocs\web-ver3 areakerja\resources\views/superadmin/login.blade.php ENDPATH**/ ?>