  ...
  <div class="limiter">
    ...
    <div class="container-login100" style= "background:linear-gradient(300.86deg, #F26419 16.15%, #FF9E00 99.77%)">
        <div class= "header">
            ...
            <div class="login100-pic js-tilt" style= "text-align: right">
                <a href="<?php echo e(route('superverifikasi')); ?>">
        ...
        <div class="col-lg-4" style= "border-radius: 63px; background:#ffffff; padding: 50px; margin-right: 300px; margin-top: -100px; padding-bottom: 100px;">
            <form class="reset100-form validate-form" method="POST" action="<?php echo e(route('resetpass')); ?>">
                ...
                <div class="lock">
                    <img src="<?php echo e(asset('img/Vector.png')); ?>" alt="IMG" style= "width: 70px; margin-left: 110px; padding-bottom: -30px; margin-bottom:-10px"> </a>
                </div>
...
<?php /**PATH D:\XAMPP\htdocs\web-ver3 areakerja\resources\views/superadmin/reset.blade.php ENDPATH**/ ?>