...
<div id="id02" class="modal">
  ...
  <form class="modal-content animate" action="/action_page.php" method="post">
    ...
    <div class="container" style= "border-style: solid; border-color: #C5C5C5">
      ...
      <div class="footer">
        <img src="<?php echo e(asset('img/img-01(2).png')); ?>" alt="IMG" width="120px" style= "margin-left: 120px; margin-top: 30px; margin-bottom: 30px" />
      </div>
    </div>
  </form>
</div>
  ...
  <form class="modal-content animate" action="/action_page.php" method="post">
    ...
    <div class="container">
      <div class="header" style="margin-bottom: 126px">
        ...
        <h1 style= "margin-left: 240px"><strong>[User]</strong> akan terhapus dari etalase anda.</h1>
      </div>
    </div>
...
<?php /**PATH D:\XAMPP\htdocs\web-ver3 areakerja\resources\views/price/draft2.blade.php ENDPATH**/ ?>