            ...
            <div class="wrap-login100">
                ...
                <div class="login100-pic js-tilt" data-tilt>
                    <a href="<?php echo e(route('home')); ?>">
                        <img src="<?php echo e(asset('img/signPer.png')); ?>" alt="IMG"> </a>
                </div>
                ...
                <form class="login100-form validate-form" method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="text-right p-t-12">
                        <a class="txt2" style= "color: orange" href="<?php echo e(route('registerperu')); ?>">
                            Ayo daftar
                        </a>
                    </div>
                    ...
                    <div class="text-right p-t-12">
                        <a class="txt2" href="<?php echo e(route('Lupapassper')); ?>">
                            Forgot Password?
                        </a>
                    </div>
...
<?php /**PATH D:\XAMPP\htdocs\web-ver2 areakerja\resources\views/mitra/auth/login.blade.php ENDPATH**/ ?>