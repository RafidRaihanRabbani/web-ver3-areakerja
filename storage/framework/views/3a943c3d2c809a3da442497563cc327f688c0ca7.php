...
<body>
    <div class="limiter">
        <div class="container-login100" style= "background:#000000">
            ...
            <div class="col-lg-4" style= "background:#ffffff; padding: 50px; padding-above: 80px; padding-bottom: 78px;">
...
unset($__errorArgs, $__bag); ?>" required autocomplete="email" value="<?php echo e(old('email')); ?>" type="email" name="email" placeholder="No.Telepon Perusahaan">
...
<?php /**PATH D:\XAMPP\htdocs\web-ver3 areakerja\resources\views/mitra/auth/register2.blade.php ENDPATH**/ ?>