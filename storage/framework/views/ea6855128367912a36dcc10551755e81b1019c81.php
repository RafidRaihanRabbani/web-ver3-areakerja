...
<button onclick="document.getElementById('id03').style.display='block'" style="width:auto;">Top Up</button>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="/action_page.php" method="post">
    ...
    <div class="container">
      ...
      <div class= "title">
        <h1 style= "font-size: 20px; text-align: center">Metode Pembayaran</h1>
      </div>
    ...
    <div class="container" style="background-color:#f1f1f1">
      ...
      <button onclick="document.getElementById('id02').style.display='block'" style="width:auto;">Selanjutnya ></button>
    </div>
  </form>
</div>
...
<div id="id03" class="modal">
  ...
  <form class="modal-content animate" action="/action_page.php" method="post">
    ...
    <div class="container">
      ...
      <div class="header" style="margin-bottom: 20px">
        <h1 style= "font-size: 40px; margin-left: 430px">Upss!</h1>
        <h1 style= "margin-left: 250px">Koin anda kurang. Silahkan Top Up</h1>
        <h1 style= "margin-left: 370px">terlebih dahulu.</h1>
      </div>

      <div class="button">
        <button type="button" onclick="document.getElementById('id03').style.display='none'" class="cancelbtn">Top Up</button>
      </div>
...
<?php /**PATH D:\XAMPP\htdocs\web-ver3 areakerja\resources\views/price/draft.blade.php ENDPATH**/ ?>