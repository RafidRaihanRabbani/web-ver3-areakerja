  ...
  <div class="limiter">
    <div class="container-login100" style= "background:linear-gradient(300.86deg, #F26419 16.15%, #FF9E00 99.77%)">
      <div class= "header">
        ...
        <div class="login100-pic js-tilt" style= "text-align: right">
          <a href="<?php echo e(route('superlogin')); ?>">
      ...
      <div class="col-lg-4" style= "border-radius: 63px; background:#ffffff; padding: 50px; margin-right: 300px; margin-top: -200px;">
        <form class="login100-form validate-form" method="POST" action="<?php echo e(route('login')); ?>">
          ...
          <div class="text-right p-t-12" style= "margin-bottom: 10px;">
            <a class="txt1" style= "color: rgb(0, 0, 0);  font-size: 10px">
              Masukkan email untuk mengatur kata sandi anda
            </a>
          </div>
...
<?php /**PATH D:\XAMPP\htdocs\web-ver3 areakerja\resources\views/superadmin/lupa.blade.php ENDPATH**/ ?>