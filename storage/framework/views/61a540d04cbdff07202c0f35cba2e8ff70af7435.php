            ...
            <div class="col-12 col-sm-8 mb-5 ml-auto mr-auto form-wrap-main">
                <form method="POST" enctype="multipart/form-data" action="<?php echo e(url('kontakform')); ?>"
                    ...
                    <div class="container ">
                        ...
                        <button type="button" class="btn btn-area text-left mb-3 mt-3" data-toggle="modal" data-target="#isidata" data-whatever="kirim">
                            <span></span> Kirim
                        </button>
...
<?php echo $__env->make('user.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\web-ver3 areakerja\resources\views/isidata/isi.blade.php ENDPATH**/ ?>