            ...
            <div class="col-lg-6" style= "border-radius: 8px; background:#ffffff; padding: 50px; margin-right: 50px; padding-bottom: 100px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                <form class="login100-form validate-form" method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class= "header" style= "background: #FF9637; border-radius: 8px; margin-right: -258px; margin-left: -50px; margin-top: -50px">
                        ...
                        <div class= "image">
                            <img src="<?php echo e(asset('img/Rectangle5.png')); ?>" alt="IMG" style="margin-left: 400px; width: 200px;">
                        </div>
                    </div>
                                
                    <div class="wrap-input101 validate-input" data-validate="Email salah, coba lagi " style= "margin-top: 10px; width: 180%">
                        <label> Username </label>
                        <input class="input101<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" required autofocus placeholder="Enter username" value="<?php echo e(old('email', null)); ?>" type="text" name="username" style= "border-style: solid; border-color: #CED4DA;">
                    ...
                    <div class="wrap-input101 validate-input" data-validate=" Password salah, coba lagi atau klik Lupa sandi untuk mereset" style= "width: 180%">
                        ...
                        <input class="input101<?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>" required placeholder="Enter password" type="password" name="password" style= "border-style: solid; border-color: #CED4DA;">
                    ...
                    <div class="container-finance100-form-btn">
                        <button class="finance100-form-btn" type="home" href<?php echo e(route ('login')); ?> >
                            Log In
                        </button>
                    </div>
                </form>
...
<?php /**PATH D:\XAMPP\htdocs\web-ver3 areakerja\resources\views/finance/login.blade.php ENDPATH**/ ?>