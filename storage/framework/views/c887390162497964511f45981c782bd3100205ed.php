            ...
            <div class="wrap-login100">
                ...
                <div class="login100-pic js-tilt" data-tilt>
                    <a href="<?php echo e(route('home')); ?>">
                        <img src="<?php echo e(asset('img/img-01(2).png')); ?>" alt="IMG"> </a>
                </div>
                ...
                <form class="login100-form validate-form" method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="container-login100-form-btn">
                        <a href="<?php echo e(route('superreset')); ?>">
                    ...
                    <div class="text-center p-t-12">
                        ...
                        <a class="txt2" href="<?php echo e(route('superlogin')); ?>">
                            Log in
                        </a>
                    </div>
                </form>
...
<?php /**PATH D:\XAMPP\htdocs\web-ver2 areakerja\resources\views/superadmin/lupa.blade.php ENDPATH**/ ?>