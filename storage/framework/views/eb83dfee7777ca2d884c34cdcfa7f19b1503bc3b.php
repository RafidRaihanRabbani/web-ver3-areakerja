...
<meta name="description" content="Menjadi bagian dari kandidat areakerja.com dan dapatkan pekerjaan impian anda">
<meta name="keywords" content="kandidat">
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-12 col-md-5 text-center text-lg-left">
                    ...
                    <a class="btn btn-lg mt-3 ml-3" href="<?php echo e(route('kandidat.awal')); ?>" style="background:#fe7b54; color:white;" type="button">Login</a>
                </div>
                <div class="col-7 col-md-7 d-none d-md-block">
                    <img class="img-fluid" src="<?php echo e(asset('img/kandidat/Hiring.png')); ?>">
                </div>
            </div>
...
<?php $__env->startSection('slick2'); ?>
    ...
    <div style="display:flex;align-items:center" class="mb-5 mt-4">
        <img style="position: absolute; top: 53%; right: 0" src="<?php echo e(asset('img/kandidat/vector 2.svg')); ?>" alt="">
        <div class="container">
...
<?php echo $__env->make('layouts.pasang3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\web-ver2 areakerja\resources\views/pasang/kandidat.blade.php ENDPATH**/ ?>